<template>
  <div class="home">
      ...
      <div class="news_section">
        ...
        <div class="news_">
          ...
          <div class="right">
            <ul>     	
                <li>
                <a href="/news/qydt/188.html" target="_blank"><h1><i></i>筑梦2018·芭提雅智能拼装别墅长春分公司产品项目说明会正式启动</h1></a>	
          ...
          <div class="more_news">
            <a href="/news/" class="new_btn" >更多新闻 NEWS MORE</a>
          </div>
      ...
      <div class="case_section">
        ...
        <div class="case_more">
          <a href="/anli/" class="btn1" style="bottom: 25px;">更多案例 CASE MORE</a>
        </div>
      </div>
