    ...
    return {
      datas:[
        ...
        {title:"前景规划",
         produce:[
          {
            text1:`<div class="nyjjnr"><p><strong>发展规划：</strong></p>
...
<p style="text-align: center;"><img alt="发展" srequire(rc="../assets/image/join2_1.png") style="width: 600px; height: 400px;"></p>
...
<p style="text-align: center;"><img alt="四大片区" srequire(rc="../assets/image/join2_2.jpg") style="width: 600px; height: 424px;"><br>
<img alt="四大片区" srequire(rc="../assets/image/join2_3.png")></p>
...
<p style="text-align: center;"><img alt="未来蓝图" srequire(rc="../assets/image/join2_4.jpg")></p>
</div>`
          }
         ]
        },
